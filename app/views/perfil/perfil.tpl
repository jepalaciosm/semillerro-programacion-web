...
{capture assign='right'}    
    <textarea placeholder="¿Qué estás pensando?" rows="3" class="col-lg-12"></textarea> 
    <button class="btn pull-right btn-primary">Publicar</button>
{/capture}
{capture assign='portada'}
    <div>
    <img src="http://i.ytimg.com/vi/7aIbP9KaXiU/maxresdefault.jpg" width="1150" height="300">
    <p><br>
    </div>
{/capture}
